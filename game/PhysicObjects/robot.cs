...
namespace skylands.PhysicObjects
{
    ...
    public class Character : PhysicObject
    {

        public Character(Game game, Model model, Vector3 sideLengths, Matrix orientation, Vector3 position)
            : base(game, model)
        {
            body = new Body();
